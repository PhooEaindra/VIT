	 ...
	 <div id="sidebar-left" class="span2">
		<div class="nav-collapse sidebar-nav">  
			...
			<ul class="nav nav-tabs nav-stacked main-menu">
				...
				<li><a href="delivery.php"><i class="icon-user"></i><span class="hidden-tablet"> Delivery</span></a></li>
<!-- 				<li><a href="messages.html"><i class="icon-envelope"></i><span class="hidden-tablet"> Messages</span></a></li>
				...
				<li>
					...
					<ul>
						...
						<li><a class="submenu" href="newitemlist.php"><i class="icon-file-alt"></i><span class="hidden-tablet"> New Item List</span></a></li>
						<li><a class="submenu" href="order.php"><i class="icon-file-alt"></i><span class="hidden-tablet">Order List</span></a></li>
					</ul>	
				</li>
